                        ...
                        <div className="content">
                            ...
                            <form name='sign_up' id='signUp' method='post' action="">
                                <div className="join email">
                                    <label>이메일</label>
                                    <input type="text" className='email' name='user_email1' id='userEmail1' placeholder='이메일'/>
                                    <i>@</i>
                                    <select type="text" name='user_email2' id='userEmail2'>
                                ...
                                <div className="join">
                                    ...
                                    <input type="password" name='user_pw' id='userPw' placeholder='비밀번호'/>                       
                                </div>
                                <div className="join">
                                    <label>비밀번호 확인</label>
                                    <input type="password" name='user_pw_ok' id='userPwOk' placeholder='비밀번호 확인'/>                       
                                </div>
                                <div className="join">
                                    <label>닉네임</label>
                                    <p>다른 유저와 겹치지 않도록 입력해주세요. (2~15자)</p>
                                    <input type="text" name='user_nick' id='userNick' placeholder='별명 (2~15자)'/>                       
                                </div>
                                <div className="join">
                                    <label>약관동의</label>
                                    <div className="check-box">
                                        <label className='check'>
                                        <input type="checkbox" name='user_agr_all' id='userAgrAll' value={'전체동의'}/> 전체동의 <span>선택항목에 대한 동의 포함</span>
                                        </label>               
                                        <label className='check'>
