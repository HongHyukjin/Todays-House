...
export default function SignUpComponent () {
    ...
    const onSubmitSignUp=(e)=>{
        ...
        //     setState({
        //         ...state,
        //         isEmailMsg: '이메일을 입력하세요'
        //     })
        // }
        // else if(state.이메일도메인===''){
        //     setState({
        //         ...state,
        //         isEmailMsg: '도메인을 입력하세요'
        //     })
        // }
        // else if(state.비밀번호===''){
        //     setState({
        ...
        //     setState({
        //         ...state,
        //         isPw2Msg: '한번더 비밀번호를 입력하세요'
        //     })
        // }
        // else if(state.닉네임===''){
        //     setState({
        //         ...state,
        //         isNickMsg: '닉네임을 입력하세요.'
        //     })
        // }
        // else if(cnt < 3) {
        //     setState({
        //         ...state,
        //         isUserServiceMsg: '이용약관 필수항목 3개를 선택해야합니다/'
        //     })
        // }
        // else {
            ...
            <div className="container">
                <div className="gap">
                    ...
                    <div className="content">
                        ...
                        <form name='sign_up' id='signUp' method='post' onSubmit={onSubmitSignUp}>
