                        ...
                        <div className="content">
                            ...
                            <form name='sign_up' id='signUp' method='post' action="">
                                <div className="join email">
                                    ...
                                    />
                                    <i>@</i>
                                    <select onChange={onChangeUserEmail2} type="text" name='user_email2' id='userEmail2'>
