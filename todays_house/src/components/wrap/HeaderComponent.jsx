                            ...
                            <div className="headbox">
                                <div className="left">
                                    <ul>
                                        ...
                                        <li><Link to="/서브페이지/서브1" onMouseEnter={onMouseEnterNav}>커뮤니티</Link></li>
                                        <li><Link to="/쇼핑페이지">쇼핑</Link></li>
                                    ...
                                    state.isLogin && (
                                        <div className="login-right">
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="" className='avartar-box' onClick={onClickSub2}><img src="./images/avatar.png" alt="" /></a>
                                                    {
                                                        state.isSub2 && (
                                                            <div className="sub1">
                                                                <ul>
