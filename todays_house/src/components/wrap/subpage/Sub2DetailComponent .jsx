        ...
        <div id='sub2Detail'>
            <div className="container">
                <div className="sub2-img-up">
                    <img src={`/images/sub2/${집들이[id].배너이미지}` }alt="" />
                </div>
                <div className="gap">
                    <div className="title">
                        <h1>{집들이[id].설명란}</h1>
                    ...
                    <div className="nick-box">
                        <div className="nickname">
                            <img src={`/images/sub2/${집들이[id].이미지2}`} alt="" />
                            <div className="name">
                                <h3>{집들이[id].출처}</h3>
                                <p>{집들이[id].시간}</p>
                            </div>
                    ...
                    <div className="info-box">
                        ...
                        <dl className='bottom'>
                            <div><dt>공간</dt><dd>{집들이[id].주거형태}</dd></div>
                            <div><dt>평수</dt><dd>{집들이[id].평수}</dd></div>
                            <div><dt>작업</dt><dd>{집들이[id].작업자}</dd></div>
                            <div><dt>분야</dt><dd>{집들이[id].작업분야}</dd></div>
                            <div><dt>가족형태</dt><dd>{집들이[id].가족형태}</dd></div>
                            <div><dt>지역</dt><dd>{집들이[id].지역}</dd></div>
                            <div><dt>스타일</dt><dd>{집들이[id].스타일}</dd></div>
                        </dl>
                    </div>
                    <div className="sub2-img-bottom">
                        <img src={`/images/sub2/${집들이[id].메인이미지}`} alt="" />
