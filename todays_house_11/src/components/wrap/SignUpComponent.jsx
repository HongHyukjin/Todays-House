...
export default function SignUpComponent () {
    ...
    React.useEffect(() => {
        ...
        setState({
            ...
            isEmailError:isEmailError,
            isEmailDomainError:isEmailDomainError,
            isEmailMsg:isEmailMsg
        })
                            ...
                            <form name='sign_up' id='signUp' method='post' action="" onSubmit={onSubmitSignUp}>
                                <div className="join email">
                                    ...
                                    <div className='email-box'>
                                        ...
                                        <i>@</i>
                                        <div>
                                            <select type="text" name='user_email2' id='userEmail2' onChange={onChangeEmailDomain} ref={selectEmail}>
                                            ...
                                            </select> 
                                            {
                                                state.isEmailInput&&(
                                                    <>
                                                        <input className='email-input' type="text" name='user_email2' id='userEmail3' placeholder='직접 입력해주세요' onChange={onChangeEmailDomain} /> 
